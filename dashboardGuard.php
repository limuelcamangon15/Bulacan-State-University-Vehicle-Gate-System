...
<body>
  ...
  <div class="navbar" id="navbar">
    ...
    <ul>
        <li><a href="dashboardGuard.php" class="active-nav"><i class="fas fa-chart-line"></i> Dashboard</a></li>
  ...
  <div class="heading-div">
    <h1><i class="fas fa-chart-line"></i> Vehicle Gate Guard Dashboard</h1>
  </div>
