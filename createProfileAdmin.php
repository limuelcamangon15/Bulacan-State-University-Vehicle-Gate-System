  ...
  <div class="navbar" id="navbar">
    ...
    <ul>
        ...
        <div class="dropdown">
            ...
            <a href="profileAdmin.php"  class="active-nav"><i class="fas fa-user-circle"></i> Profile</a>
    ...
    <div class="form-container">
        ...
        <div class="input-group full-width">
            <button class="cancel-btn" type="button" onclick="window.location.href='profileAdmin.php'">Cancel</button>
        </div>
    </div>
