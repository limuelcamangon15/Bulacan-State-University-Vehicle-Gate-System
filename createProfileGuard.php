  ...
  <div class="navbar" id="navbar">
    ...
    <ul>
        ...
        <a href="accountGuard.php"><i class="fas fa-user"></i> Account</a>
            <a href="profileGuard.php" class="active-nav"><i class="fas fa-user-circle"></i> Profile</a>
    ...
    <div class="form-container">
        ...
        <p>Fill up all fields to create your a profile</p>

        <form method="POST" enctype="multipart/form-data">
            <div class="row">
            <div class="input-group">
                <label for="accountID">Account ID</label>
                <input type="number" id="accountID" name="account_id" required readonly value="<?php echo $accountID; ?>">
        ...
        <div class="input-group full-width">
            <button class="cancel-btn" type="button" onclick="window.location.href='profileGuard.php'">Cancel</button>
        </div>
    </div>
    ...
    <script>
      Swal.fire({
        ...
        if(result.isConfirmed || result.dismiss){
          window.location.href = 'profileGuard.php';
        }
      });
    </script>
    <?php endif; ?>
