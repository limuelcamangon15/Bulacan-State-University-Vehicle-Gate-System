...
<head>
  ...
  <title>Vehicle Movement Logs</title>
...
<body>
  ...
  <div class="navbar" id="navbar">
    ...
    <ul>
        ...
        <li><a href="gatesAdminAccessLogs.php"  class="active-nav"><i class="fas fa-shield-alt"></i> Logs/Access</a></li>
        <li>
  ...
  <div class="main-container">
    ...
    <div class="filter-section">     
        <form method="GET" action="gatesAdminAccessLogs.php" style="display:inline;">
