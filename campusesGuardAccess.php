...
<body>
  ...
  <div class="navbar" id="navbar">
    ...
    <ul>
        ...
        <li><a href="campusesGuardAccess.php" class="active-nav"><i class="fas fa-university"></i> Campuses</a></li>
  ...
  <div class="main-container">
    ...
    <div class="filter-section">
        ...
        <form method="GET" action="campusesGuardAccess.php" style="display:inline;">         
