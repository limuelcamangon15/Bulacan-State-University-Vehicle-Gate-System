...
<body>
  ...
  <div class="navbar" id="navbar">
        ...
        <form method="POST" enctype="multipart/form-data">
          <div class="row">
            <div class="input-group">
                ...
                <span id="plateNumber-error" style="height: 0px; align-self: center; color: red; font-weight: bold; margin-top: 3px; font-size: 13px; display: none;">Vehicle already registered</span>
            </div>
            ...
            <div class="input-group">
                ...
                <input type="number" id="ownerID" name="owner_id" required readonly value="<?php echo $accountID;?>">
            </div>
    ...
    <?php if (!empty($vehicleAdded) && $vehicleAdded): ?>
      <script>
        Swal.fire({
          title: 'Vehicle Registration Sent Successfully!',
          text: 'Your vehicle registration has been sent successfully, wait for admin approval!',
          icon: 'success',
