...
<body>
  ...
  <div class="navbar" id="navbar">
    ...
    <ul>
        ...
        <li><a href="gatesGuardAccessLogs.php" class="active-nav"><i class="fas fa-shield-alt"></i> Logs/Access</a></li>
        <li>
  ...
  <div class="main-container">
    ...
    <div class="summary-container">
        <div class="summary-card">
            ...
            <?php 
                $resultc = $conn->query("SELECT COUNT(*) AS total FROM gatelogs WHERE AccessType = 'entry'");
        ...
        <div class="summary-card">
            ...
            <?php 
                $resultb = $conn->query("SELECT COUNT(*) AS total FROM gatelogs WHERE AccessType = 'exit'");
    ...
    <div class="filter-section">
        <button class="add-btn" onclick="window.location.href='logVehicleMovement.php'"><i class="fas fa-plus" ></i> Log Vehicle Movement</button>

        <form method="GET" action="gatesGuardAccessLogs.php" style="display:inline;">
