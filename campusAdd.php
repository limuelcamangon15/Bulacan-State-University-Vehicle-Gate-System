 <?php
    ...
    if($_SERVER['REQUEST_METHOD'] === 'POST'){
        ...
        $stmt = $conn->prepare("INSERT INTO campuses (CampusName, Address) VALUES (?, ?)");

        if ($stmt) {
            $stmt->bind_param("ss", $campusName, $address);
...
<body>
  ...
  <div class="navbar" id="navbar">
    ...
    <div class="form-container">
        <h2>Add Campus</h2>
        <p>Fill up this form to add a new campus</p>
    
        <form method="POST">
            <div class="input-group">
                <label for="campusName">Campus Name</label>
                <input type="text" id="campusName" name="campus_name" required>
                <span id="campusName-error" class="error-message"><i class="fas fa-exclamation-triangle" style="color: #facc15; margin-right: 5px;"></i>  Campus already exists</span>
            </div>
    ...
    <?php if (!empty($campusAdded) && $campusAdded): ?>
      <script>
          Swal.fire({
              title: 'Campus Added Successfully!',
              text: 'The campus has been added Successfully!',
              icon: 'success',
    ...
    <script>
      ...
      function checkCampusName() {
        ...
        xhr.send('campus_name=' + encodeURIComponent(name));
      }
