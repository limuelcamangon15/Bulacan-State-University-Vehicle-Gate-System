...
<body>
  ...
  <div class="navbar" id="navbar">
    ...
    <ul>
        ...
        <li><a href="vehicleGuardAccess.php" class="active-nav"><i class="fas fa-car"></i> Vehicles</a></li>
  ...
  <div class="main-container">
    ...
    <div class="filter-section">
        ...
        <form method="GET" action="vehicleGuardAccess.php" style="display:inline;">
